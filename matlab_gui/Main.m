...
array = readmatrix(fullfile(project_folder, 'data_structure.xlsx'), 'Range', 'A2');
data = array;
...
writematrix(U,   fullfile(project_folder, 'displacement.xlsx'));
writematrix(Sx,  fullfile(project_folder, 'stress_x.xlsx'));
writematrix(Sy,  fullfile(project_folder, 'stress_y.xlsx'));
writematrix(Sxy, fullfile(project_folder, 'stress_xy.xlsx'));
